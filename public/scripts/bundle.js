...
React.render(
  React.createElement(MainRegistration, null),
  document.getElementById('content')
);

},{"./MainRegistration.jsx":160,"react":157}],159:[function(require,module,exports){
'use strict';
...
render : function(){
    return (
    React.createElement("div", null, " User Name : ", this.props.formFields.userName, React.createElement("br", null), 
    "Password : ", this.props.formFields.password, React.createElement("br", null), 
    "Email : ", this.props.formFields.email, React.createElement("br", null), 
    "Address : ", this.props.formFields.address, React.createElement("br", null), 
    "Country : ", this.props.formFields.country, React.createElement("br", null), 
    "Date Of Birth : ", this.props.formFields.dateOfBirth, React.createElement("br", null), 
    "Security Question : ", this.props.formFields.securityQuestion, React.createElement("br", null), 
      ...
      switch(this.state.step){
        ...
        case 2:
          return React.createElement(PersonalDetails, {formFields: formFields, 
                                    ...
                                    saveValues: this.saveValues})
        case 3:
          return React.createElement(SecurityQuestions, {formFields: formFields, 
                                    nextStep: this.nextStep, 
                                    previousStep: this.previousStep, 
                                    saveValues: this.saveValues})
        case 4:
    ...
    render: function() {
        ...
        React.createElement("div", {className: "registration"}, 
            React.createElement("main", null, 
              React.createElement("span", null, React.createElement("b", null, "Step ", this.state.step)), 
...
var PersonalDetails = React.createClass({displayName: "PersonalDetails",
render : function(){
    return (
            React.createElement("div", null, " ", React.createElement("h3", null, "Personal Details "), 
                React.createElement("label", {for: "address"}, "Address :"), 
                  React.createElement("input", {type: "text", className: "form-control", defaultValue: this.props.formFields.address, ref: "address"}), 
                  React.createElement("label", {for: "country"}, "Country :"), 
                  React.createElement("input", {type: "text", className: "form-control", defaultValue: this.props.formFields.country, ref: "country"}), 
                  React.createElement("label", {for: "dateOfBirth"}, "Date of Birth :"), 
                  React.createElement("input", {type: "text", className: "form-control", defaultValue: this.props.formFields.dateOfBirth, ref: "dateOfBirth"}), 
                  React.createElement("br", null), 
                  React.createElement("input", {type: "Previous", value: "Previous", className: "btn btn-default", onClick: this.props.previousStep}), "  ", 
    ...
    return (
      React.createElement("div", {className: "form-group"}, 
        ...
        React.createElement("h3", {className: "test"}, " User Registration "), 
          ...
          React.createElement("input", {type: "text", className: "form-control", defaultValue: this.props.formFields.password, ref: "password"}), 
          React.createElement("label", {for: "email"}, "Email :"), 
          React.createElement("input", {type: "text", className: "form-control", defaultValue: this.props.formFields.email, ref: "email"}), 
          React.createElement("br", null), 
          React.createElement("input", {type: "Next", value: "Save & Continue", className: "btn btn-default", onClick: this.nextStep})
      )
    );
  },
  nextStep : function(e){
...
var SecurityQuestions = React.createClass({displayName: "SecurityQuestions",
render : function(){
    return (
        React.createElement("div", null, " ", React.createElement("h3", null, "Security Questions"), 
            React.createElement("label", {for: "address"}, "Question :"), 
              React.createElement("input", {type: "text", className: "form-control", defaultValue: this.props.formFields.securityQuestion, ref: "securityQuestion"}), 
              React.createElement("label", {for: "country"}, "Answer :"), 
              React.createElement("input", {type: "text", className: "form-control", defaultValue: this.props.formFields.answer, ref: "answer"}), 
              React.createElement("br", null), 
              React.createElement("input", {type: "Previous", value: "Previous", className: "btn btn-default", onClick: this.props.previousStep}), " ", 
              React.createElement("input", {type: "text", value: "Save & Continue", className: "btn btn-default", onClick: this.nextStep})
        )
